...
dwf.FDwfDigitalSpiDataSet(hdwf, c_int(0), c_int(
    idxMosi))  # 0 DQ0_MOSI_SISO = DIO-2
...
dwf.FDwfDigitalInTriggerSet(hdwf, c_int(0), c_int(
    0), c_int((1 << idxClk) | (1 << idxCS)), c_int(0))
...
while True:
    ...
    dwf.FDwfDigitalInStatusRecord(hdwf, byref(
        cAvailable), byref(cLost), byref(cCorrupted))
